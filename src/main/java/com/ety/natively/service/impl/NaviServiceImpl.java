...
public class NaviServiceImpl implements NaviService {
	...
	private String askNaviTranslation(NaviRequestDto dto) {
		...
		String displayLanguage = language.getDisplayLanguage(Locale.CHINESE);
		Prompt prompt = TRANSLATION_SYSTEM_PROMPT_TEMPLATE.create(Map.of("language", displayLanguage, "format", TRANSLATION_JSON_OBJECT), TRANSLATION_OPTIONS);
	...
	private String askNaviExplanation(NaviRequestDto dto) {
		Locale language = BaseContext.getLanguage();
		String displayLanguage = language.getDisplayLanguage(Locale.CHINESE);
		Prompt prompt = EXPLANATION_SYSTEM_PROMPT_TEMPLATE.create(Map.of("language", displayLanguage), EXPLANATION_OPTIONS);
		return chatClient.prompt(prompt)
				.user(dto.getQuote())
				.call()
				.content();
	...
	private final String TRANSLATION_JSON_SCHEMA = """
			...
			""";
	private final String TRANSLATION_JSON_OBJECT = """ 
